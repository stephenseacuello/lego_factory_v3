...
from models.qms.supplier_quality import InspectionMeasurement, InspectionRecord
...
class SPCService:
    ...
    def calculate_control_limits(
        ...
        ).order_by(InspectionMeasurement.created_at.desc()).limit(
    ...
    def calculate_process_performance(
        ...
        ).order_by(InspectionMeasurement.created_at.desc()).limit(limit).all()
