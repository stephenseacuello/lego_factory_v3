...
class GrblSimulatorNode(Node):
    ...
    def publish_status(self):
        ...
        # GRBL-specific status (matching cnc_interfaces/msg/GrblStatus)
        ...
        grbl_msg.machine_id = self.machine_id
        grbl_msg.state = self.machine.state.name  # String state name
        grbl_msg.state_code = self.machine.state.value

        grbl_msg.report_machine_pos = True
        grbl_msg.pos_x = self.machine.x
        grbl_msg.pos_y = self.machine.y
        grbl_msg.pos_z = self.machine.z
        ...
        grbl_msg.planner_blocks_available = 15
        grbl_msg.rx_chars_available = 128
        ...
        machine_msg.state = grbl_msg.state_code
        machine_msg.state_text = grbl_msg.state
        machine_msg.mpos_x = grbl_msg.pos_x
        machine_msg.mpos_y = grbl_msg.pos_y
        machine_msg.mpos_z = grbl_msg.pos_z
        machine_msg.wpos_x = grbl_msg.pos_x
        machine_msg.wpos_y = grbl_msg.pos_y
        machine_msg.wpos_z = grbl_msg.pos_z
